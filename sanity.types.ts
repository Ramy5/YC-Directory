...
// Query: *[_type == "startup" && _id == $id][0] {    _id,    title,    slug,    _createdAt,     author -> {      _id, name, image, bio, username    },    description,    views,    category,    image,    pitch  }
...
// Query: *[_type == "author" && id == $id][0] {    _id,    id,    username,    name,     image,     bio,    email  }
